...
class LoanApplicationApproved extends Notification {
    ...
    public function __construct($loan) {
        ...
        $this->loan     = $loan;
        $this->template = EmailTemplate::where('slug', 'LOAN_APPLICATION_APPROVED')->first();

        $this->replace['employeeName']       = $this->loan->employee->name;
        $this->replace['loanAmount']         = $this->loan->loan_amount;
        $this->replace['monthlyInstallment'] = $this->loan->monthly_installment;
    }
