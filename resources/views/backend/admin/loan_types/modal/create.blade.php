<form method="post" class="ajax-screen-submit" autocomplete="off" action="{{ route('employee_loan_types.store') }}" enctype="multipart/form-data">
	{{ csrf_field() }}
	<div class="row px-2">
	    <div class="col-md-12">
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<select class="form-control auto-select" data-selected="{{ old('interest_type', 'declining') }}" name="interest_type"  required>
