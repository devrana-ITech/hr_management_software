...
<div class="row">
	@if(in_array('dashboard.active_employee_widget', $permissions))
	...
	@if(in_array('dashboard.leave_application_widget', $permissions))
	<div class="col-xl-3 col-md-6">
	...
	@if(in_array('dashboard.loan_application_widget', $permissions))
	<div class="col-xl-3 col-md-6">
	...
	@if(in_array('dashboard.expense_requests_widget', $permissions))
	<div class="col-xl-3 col-md-6">
...
@if(in_array('dashboard.profit_and_loss_widget', $permissions))
<div class="row">
	<div class="col-lg-12">
		<div class="card mb-4">
			...
			<div class="card-body">
				...
				<canvas id="proftLossChart" style="height: 350px"></canvas>
			</div>
		</div>
	</div>
</div>
...
@if(in_array('dashboard.recent_transactions_widget', $permissions))
<div class="row">
	<div class="col-lg-12">
		<div class="card mb-4">
			<div class="card-header">
