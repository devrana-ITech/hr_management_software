					...
					<div class="row align-items-center">
						...
						<div class="col-lg-6 col-8 clearfix rtl-1">
							...
							<ul class="notification-area float-right d-flex align-items-center">
								...
								@php $notifications = Auth::user('client')->notifications->take(15); @endphp
								@php $unreadNotification = Auth::user('client')->unreadNotifications(); @endphp
								<li class="dropdown d-none d-sm-inline-block">
									...
									<div class="dropdown-menu bell-notify-box notify-box">
										...
										<div class="nofity-list">
											...
											<a href="{{ route('client.profile.show_notification', $notification->id) }}" class="d-flex ajax-modal notify-item" data-title="{{ $notification->data['subject'] }}">	
								...
								<li>
									<div class="user-profile">
										<h4 class="user-name dropdown-toggle" data-toggle="dropdown">
											<img class="avatar user-thumb" id="my-profile-img" src="{{ profile_picture() }}" alt="avatar"> {{ Auth::user('client')->name }} <i class="fa fa-angle-down"></i>
										</h4>
										<div class="dropdown-menu">
											<a class="dropdown-item" href="{{ route('client.profile.edit') }}"><i class="ti-pencil text-muted mr-2"></i>{{ _lang('Profile Settings') }}</a>
											<a class="dropdown-item" href="{{ route('client.profile.change_password') }}"><i class="ti-exchange-vertical text-muted mr-2"></i></i>{{ _lang('Change Password') }}</a>
							
											<div class="dropdown-divider"></div>
											<a class="dropdown-item" href="{{ route('client.logout') }}"><i class="ti-power-off text-muted mr-2"></i>{{ _lang('Logout') }}</a>
										</div>
									</div>
	                            </li>
